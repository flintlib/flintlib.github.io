# 2026 FLINT development workshop in Bordeaux
...
* Wiki: [https://github.com/flintlib/flint/wiki/Workshop-2026](https://github.com/flintlib/flint/wiki/Workshop-2026)
...
Registration is free but mandatory. To register for the workshop, please contact Fredrik before May 15.

We have funding for lunches and coffee breaks.
Our ability to provide travel support is currently extremely limited; if you need
a part of your trip paid, let us know as soon as possible so that we
can look into options. Remote participation is possible.
...
* [Département de recherche Sciences de l’ingénierie et du numérique](https://sin.u-bordeaux.fr/) (SIN)
